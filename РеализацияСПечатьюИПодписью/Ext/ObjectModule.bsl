...
Функция ПечатьКомплектаУПДСПечатью(КоллекцияПечатныхФорм, МассивОбъектов, ОбъектыПечати, ИменаФайлов)
	...
	ИсходнаяСтрокаКоллекции = ОбщегоНазначения.СтрокаТаблицыЗначенийВСтруктуру(КоллекцияПечатныхФорм.Найти("УПДСПечатью", "ИмяМакета"));
	...
	Для Каждого МакетУПД Из МакетыУПД Цикл
		...
		СтрокаКоллекции = КоллекцияПечатныхФорм.Найти("УПДСПечатью", "ИмяМакета");
		...
		Если МакетУПД.Ключ = "УПДСтатус1" Тогда
			ТабДокумент = ПечатьУниверсальныхПередаточныхДокументов(МассивОбъектовПечатьУПД, ОбъектыПечатиУПД, 
				Документы.СчетФактураВыданный.ТекстЗапросаПечатьСчетовФактур(Истина, Истина, Ложь),, ТабДокумент);
		ИначеЕсли МакетУПД.Ключ = "УПДСтатус1_981" Тогда
			ТабДокумент = ПечатьУниверсальныхПередаточныхДокументов981(МассивОбъектовПечатьУПД, ОбъектыПечатиУПД, 
				Документы.СчетФактураВыданный.ТекстЗапросаПечатьСчетовФактур(Истина, Истина, Истина),, ТабДокумент);
...
Функция ПечатьУниверсальныхПередаточныхДокументов(МассивОбъектов, ОбъектыПечати, ТекстЗапросаДокументам, ТолькоПередаточныйДокумент = Ложь, ТабДокумент = Неопределено)
	...
	Возврат ТабличныйДокументУПД(
		Макет, МассивОбъектов, ОбъектыПечати, ТабДокумент, ТекстЗапросаДокументам, ТолькоПередаточныйДокумент);
	
КонецФункции

Функция ПечатьУниверсальныхПередаточныхДокументов981(МассивОбъектов, ОбъектыПечати, ТекстЗапросаДокументам, ТолькоПередаточныйДокумент = Ложь, ТабДокумент = Неопределено)
	...
	Макет = ПолучитьМакет("ПФ_MXL_УниверсальныйПередаточныйДокумент981СПечатью");
...
Функция ТабличныйДокументУПД(Макет, МассивОбъектов, ОбъектыПечати, ТабДокумент, ТекстЗапросаДокументам, ТолькоПередаточныйДокумент)
